...
Option Explicit
Dim VldMsg(4) As String

Public Sub MakeVidMsgArray()
    
    VldMsg(vbDataActionMoveFirst) = "Move First"
    VldMsg(vbDataActionMovePrevious) = "Move Previous"
    VldMsg(vbDataActionMoveNext) = "Move Next"
    VldMsg(vbDataActionMoveLast) = "Move Last"
...
If Action >= 1 And Action <= 4 Then
    MsgBox VldMsg(Action)
Else
    MsgBox "Unknown Validating Data!!!", vbInformation
End If
End Sub
...
End Sub
'******************************************
'Extra Informations in pages: 93-94-...-102
